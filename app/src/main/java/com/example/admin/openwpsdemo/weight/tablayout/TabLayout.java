...
package com.example.admin.openwpsdemo.weight.tablayout;
            ...
            if (mCustomView == null) {
                ...
                if (mTextView == null) {
                    TextView textView = (TextView) LayoutInflater.from(getContext())
                            .inflate(R.layout.app_design_layout_tab_text, this, false);
                    addView(textView);
                    mTextView = textView;
...
//                            mIndicatorRight-width/2+mTabLineOffset, getHeight());
                    ...
                    RectF oval3 = new RectF(mIndicatorLeft + mTabPaddingStart, getHeight() - mSelectedIndicatorHeight,
                            mIndicatorLeft + mTabPaddingStart+mTabLineOffset, getHeight());
                    canvas.drawRoundRect(oval3,0,0,mSelectedIndicatorPaint);
                }
            }
        }
    }
