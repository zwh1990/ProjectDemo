 ...
 * @Created by zwh.
 * @description：
 * @date 2018/8/21 23:25
 * @邮箱：zhaowh@zgjzd.cn
 */
public class DiatanceScrollView extends ScrollView {

    private static final String TAG = DiatanceScrollView.class.getSimpleName();
    // 检查ScrollView的最终状态
     ...
     * @param context
     */
    public DiatanceScrollView(Context context) {
        super(context);
    }
     ...
     * @param attrs
     */
    public DiatanceScrollView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
     ...
     * @param defStyleAttr
     */
    public DiatanceScrollView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private Handler checkStateHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            if (lastT == getScrollY()) {
                ...
                if (onScrollListener != null) {
                    onScrollListener.onScrollStateChanged(DiatanceScrollView.this,
